...
use App\Policies\Admin\AccountPolicy;
use App\Traits\DataTables\DataTable;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\DB;

trait AccountDataTable
{
    use DataTable;
    ...
    public static function dataTableEditColumns($table)
    {
        ...
        $viewAllPermission = Auth::user()->hasPermissionTo('view_all accounts');
        $viewOwnPermission = Auth::user()->hasPermissionTo('view_own accounts');
        $updateAllPermission = Auth::user()->hasPermissionTo('update_all accounts');
        $updateOwnPermission = Auth::user()->hasPermissionTo('update_own accounts');
        $deleteAllPermission = Auth::user()->hasPermissionTo('delete_all accounts');
        $deleteOwnPermission = Auth::user()->hasPermissionTo('delete_own accounts');
        $deleteForeverPermission = Auth::user()->hasPermissionTo('delete_forever accounts');
        $restoreAllPermission = Auth::user()->hasPermissionTo('restore_all accounts');
        $restoreOwnPermission = Auth::user()->hasPermissionTo('restore_own accounts');
        ...
        $dtObject = [
            'Default' => [
                ...
                'columns' => [
                    ...
                    [
                        'data' => 'marketplace_id', 'className' => 'dt_col_name', 'label' => __('Marketplace ID'),
                        'filter' => [ 'type' => "search" ]
                    ],
                ],
                'ajax' => [
